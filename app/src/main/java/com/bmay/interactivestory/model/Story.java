 ...
 */
//The Story class creates and holds the array of pages for us
//Its better to put this in here rather than in the Main/StoryActivity
public class Story {

    private Page[] mPages;

    public Story(){
        //Initialise the mPages array to have 7 pages
        mPages = new Page[7];
        //Page details could be created like this - by using the setter methods
        //But using a custom constructor defined in the Page class is better
        //mPages[0] = new Page();
        ...
        //Fill page 0 with data by calling the methods in the Page class
    ...
    //This method gets a pagenumber - pass in an index - the pagenumber
